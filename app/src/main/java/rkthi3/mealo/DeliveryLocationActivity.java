...
public class DeliveryLocationActivity extends BaseActivity
   ...
   // private FusedLocationProviderClient mFusedLocationClient;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       //showing only back button getSupportActionBar().setTitle("Delivery Location");

        mapFrag = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map_delivery);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(DeliveryLocationActivity.this,
